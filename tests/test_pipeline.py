...
SCRIPT = {
    "carrum": dict(deal_type="funding", company_name="Carrum Mobility", indian_party="Carrum Mobility",
    ...
    "qnu": dict(deal_type="funding", company_name="QNu Labs", indian_party="QNu Labs",
    ...
    "truefan": dict(deal_type="ma", company_name="TrueFan AI", indian_party="TrueFan AI", sector="AI celebrity video",
    ...
    "rentomojo_anchor": dict(deal_type="ipo", company_name="Rentomojo", indian_party="Rentomojo",
                             ...
                             confidence="high"),
    "rentomojo_sub": dict(deal_type="ipo", company_name="RentoMojo", indian_party="RentoMojo",
                          sector="furniture and appliance rental",
